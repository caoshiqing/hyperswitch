...
<Tip>We recommend using our [Dashboard](https://47.117.71.7:9000/dashboard/login) to generate API Key and setting up Connectors (Step 4) for faster trial and simple setup.</Tip>
<Steps>
  ...
  <Step title="Hyperswitch Dashboard flow" icon= "box-open">
    Access the <Tooltip tip="Control Center is a frontend interface for the API to track and test payments">[Dashboard](https://47.117.71.7:9000/dashboard/login)</Tooltip> and sign up -> **Sign up here is equivalent to creating a Merchant Account**
  </Step>
