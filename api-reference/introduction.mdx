...
| ----------- | ------------------------------ |
| Sandbox     | https://47.117.71.7:8080 |
| Production  | https://api-payment.item.com     |
...
<Check>
  Get your [API key](https://47.117.71.7:9000/dashboard/developer-api-keys) and [Publishable Key](https://47.117.71.7:9000/dashboard/home)
</Check>
