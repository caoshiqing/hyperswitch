...
<Check>
Get your [API Key](https://47.117.71.7:9000/dashboard/developer-api-keys) and [Publishable Key](https://47.117.71.7:9000/dashboard/home) from the Hyperswitch dashboard.
</Check>
---